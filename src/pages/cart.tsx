        ...
        <>
          ...
          <div className="w-full rounded-md">
            ...
            <div className="w-full mt-5 flex flex-col bg-white border rounded-md">
              ...
              <div className="flex justify-center p-6">
                <button className="w-full font-lexend bg-pink-500 hover:bg-pink-600 rounded-md p-3 text-white">
                  Confirm Order
                </button>
              </div>
            </div>
          ...
          <div className="w-full flex justify-center items-center">
            <div className="flex flex-col md:flex-row justify-center items-center md:gap-x-10 lg:gap-x-20 gap-y-5">
              ...
              <h1 className="font-lexend text-xl sm:text-2xl md:text-3xl lg:text-4xl">Your cart is currently empty</h1>
            </div>
          </div>
      </>}
    </div>
